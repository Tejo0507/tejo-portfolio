...
export const skills: SkillMeta[] = [
  ...
  },
  {
    ...
    categoryId: "ml",
    level: 88,
    description: "Statistical modeling and predictive analytics using linear and non-linear regression techniques.",
    tags: ["ml", "regression", "statistics"],
    notes: "Expertise in linear regression, polynomial regression, and regularization techniques.",
  ...
  },
  {
    ...
    categoryId: "ml",
    level: 90,
    description: "Building classification models for supervised learning tasks across various domains.",
    tags: ["ml", "classification", "supervised-learning"],
    notes: "Experience with logistic regression, decision trees, random forests, and SVM.",
    links: [{ label: "ML Projects", href: "/projects" }],
  },
  {
    id: "ai",
  ...
  },
  {
    ...
    categoryId: "backend",
    level: 75,
    description: "Systems programming and algorithm implementation in C.",
    tags: ["c", "systems", "programming"],
    notes: "Strong foundation in C programming and data structures.",
    links: [{ label: "Projects", href: "/projects" }],
  },
  {
    id: "postgres",
